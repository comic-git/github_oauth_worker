...
- Verify allowlist matching is case-insensitive, empty allowlists deny access, and policy runs both after initial authorization and token refresh.
- Verify success and failure callback pages emit Decap-compatible `postMessage` payloads.

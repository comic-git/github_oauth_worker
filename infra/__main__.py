"""Deploy one environment's Cloud Run revision and its optional runtime secrets."""
...
if not IMAGE_DIGEST_PATTERN.fullmatch(image_uri):
    raise pulumi.RunError("imageUri must be an immutable image reference with a sha256 digest.")
